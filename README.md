...
- **Projetos:** Desenvolvimento do SeenBook (implementação de capas, lógica, generos dos conteúdos e semântica html)
- **Leituras:** Documentação Python sobre a biblioteca `fractions` e `sys`, também o livro Entendendo Algoritmos de Aditya Y. Bhargava.
- **Aprendizados:**
